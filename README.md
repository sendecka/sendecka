...
| 💰 Personal Finance Dashboard in Microsoft Power BI | Managing personal finances can be challenging without a clear overview of income streams, spending habits, savings, and debt obligations. The goal of this project was to build an interactive Power BI dashboard that helps individuals track monthly income, expenses by category, available balance, and upcoming debt payments supporting better budgeting and financial decision-making.  | Microsoft Power BI  |
| 👥 HR Analytics Dashboard in Microsoft Power BI | The company struggled to track essential HR metrics such as workforce composition, promotion readiness, retirement risk, job satisfaction, and employee distribution across departments. Data was scattered across multiple reports, making it difficult for HR leadership to make informed, timely decisions. The goal of this project was to build an interactive Power BI dashboard that provides a complete overview of the organization, highlights workforce risks, and supports strategic HR planning.  | Microsoft Power BI  |
|  |   |   |
|  |   |   |
